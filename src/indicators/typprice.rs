...
use tulip_rs::indicators::typprice::{
    Indicator, IndicatorState, TIndicatorState, Typprice, INPUTS, OPTIONS,
};
...
pub fn indicator(
    ...
    match Typprice::indicator(&input_arrays, &options_array, optional_outputs.as_deref()) {
        Ok((result, state)) => Ok((
...
pub fn info(py: Python<'_>) -> PyResult<Bound<'_, pyo3::types::PyDict>> {
    crate::utils::info_to_pydict(py, Typprice::INFO)
}

#[pyfunction]
pub fn min_data(_options: Vec<f64>) -> PyResult<usize> {
    Ok(Typprice::min_data(&[]))
}
...
pub fn simd_by_assets(
    ...
    let result = match num_assets {
        2 => {
            ...
            Typprice::indicator_by_assets::<2>(
                input_array,
                &options_array,
        ...
        4 => {
            ...
            Typprice::indicator_by_assets::<4>(
                input_array,
                &options_array,
                optional_outputs.as_deref(),
            )
        ...
        8 => {
            ...
            Typprice::indicator_by_assets::<8>(
                input_array,
                &options_array,
                optional_outputs.as_deref(),
            )
        ...
        16 => {
            ...
            Typprice::indicator_by_assets::<16>(
                input_array,
                &options_array,
                optional_outputs.as_deref(),
            )
