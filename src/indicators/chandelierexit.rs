...
use tulip_rs::indicators::chandelierexit::{
    ChandelierExit, Indicator, IndicatorByOptions, IndicatorState, INPUTS, OPTIONS,
};
...
pub fn indicator(
    ...
    match ChandelierExit::indicator(&input_arrays, &options_array, optional_outputs.as_deref()) {
        Ok((result, state)) => Ok((
...
pub fn info(py: Python<'_>) -> PyResult<Bound<'_, pyo3::types::PyDict>> {
    crate::utils::info_to_pydict(py, ChandelierExit::INFO)
}
...
pub fn min_data(options: Vec<f64>) -> PyResult<usize> {
    ...
    Ok(ChandelierExit::min_data(&options_array))
}

/// Calculate Chandelier Exit for multiple assets using SIMD operations
///
...
/// - options: Vector containing [period, step] for the chandelier exit calculation
/// - optional_outputs: Optional list of booleans for additional outputs (atr, tr, min, max)
///
/// Returns:
/// - Tuple of (outputs, states) where:
///   - outputs: Vector of Chandelier Exit results for each asset
///   - states: Vector of ChandelierExitState objects for continuing calculations
///
...
pub fn simd_by_assets(
    ...
    let result = match num_assets {
        2 => {
            ...
            ChandelierExit::indicator_by_assets::<2>(
                input_array,
                &options_array,
        ...
        4 => {
            ...
            ChandelierExit::indicator_by_assets::<4>(
                input_array,
                &options_array,
                optional_outputs.as_deref(),
            )
        ...
        8 => {
            ...
            ChandelierExit::indicator_by_assets::<8>(
                input_array,
                &options_array,
                optional_outputs.as_deref(),
            )
        ...
        16 => {
            ...
            ChandelierExit::indicator_by_assets::<16>(
                input_array,
                &options_array,
                optional_outputs.as_deref(),
            )
...
/// Calculate Chandelier Exit for a single asset with multiple options using SIMD
///
/// Parameters:
...
/// Returns:
/// - Tuple of (outputs, states) where:
///   - outputs: Vector of Chandelier Exit results for each option set
///   - states: Vector of ChandelierExitState objects for continuing calculations
#[pyfunction]
#[pyo3(signature = (inputs, options, optional_outputs=None))]
pub fn simd_by_options(
    ...
    let result = match num_options {
        2 => {
            ...
            ChandelierExit::indicator_by_options::<2>(
                &input_arrays,
                opt_array,
                optional_outputs.as_deref(),
            )
        ...
        4 => {
            ...
            ChandelierExit::indicator_by_options::<4>(
                &input_arrays,
                opt_array,
                optional_outputs.as_deref(),
            )
        ...
        8 => {
            ...
            ChandelierExit::indicator_by_options::<8>(
                &input_arrays,
                opt_array,
                optional_outputs.as_deref(),
            )
        ...
        16 => {
            ...
            ChandelierExit::indicator_by_options::<16>(
                &input_arrays,
                opt_array,
                optional_outputs.as_deref(),
            )
...
/// Register the Chandelier Exit indicator module with Python
///
/// This function creates a Python submodule for the Chandelier Exit indicator and registers
